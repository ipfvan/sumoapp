...
const MetodeSunat = () => {
  ...
  const fetchMetodeSunatList = () => {
    axios.get('/api/ciledug/main/metodesunat')
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('/api/ciledug/main/metodesunat', newMetode)
      .then(() => {
        fetchMetodeSunatList();
  ...
  const handleUpdate = () => {
    axios.put(`/api/ciledug/main/metodesunat?id=${editMetode.id}`, editMetode)
      .then(() => {
        fetchMetodeSunatList();
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`/api/ciledug/main/metodesunat?id=${id}`) // Ganti dengan URL delete endpoint yang sesuai
      .then(() => {
