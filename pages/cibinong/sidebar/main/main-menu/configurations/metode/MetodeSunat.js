...
const MetodeSunat = () => {
  ...
  const fetchMetodeSunatList = () => {
    axios.get('/api/cibinong/main/metodesunat')
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('/api/cibinong/main/metodesunat', newMetode)
      .then(() => {
        fetchMetodeSunatList();
  ...
  const handleUpdate = () => {
    axios.put(`/api/cibinong/main/metodesunat?id=${editMetode.id}`, editMetode)
      .then(() => {
        fetchMetodeSunatList();
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`/api/cibinong/main/metodesunat?id=${id}`) // Ganti dengan URL delete endpoint yang sesuai
      .then(() => {
