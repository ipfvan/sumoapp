...
export default async function handler(req, res) {
  try {
    if (req.method === 'GET') {
      ...
      const rows = await executeCibinong(sql);
      ...
      await executeCibinong(deleteSql, [id]);
      ...
      await executeCibinong(insertSql, [nama, no_telp, alamat]);
      ...
      await executeCibinong(updateSql, [updatedItem, itemId]);
