...
export default async function handler(req, res) {
  try {
    if (req.method === 'GET') {
      ...
      const rows = await executePamulang(sql);
      ...
      await executePamulang(deleteSql, [id]);
      ...
      await executePamulang(insertSql, [nama, no_telp, alamat]);
      ...
      await executePamulang(updateSql, [updatedItem, itemId]);
