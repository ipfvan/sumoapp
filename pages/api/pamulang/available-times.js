...
export default async function handler(req, res) {
  ...
  try {
    ...
    const configData = await executePamulang(getConfigQuery);
    ...
    const specialConfigData = await executePamulang(getSpecialConfigQuery, [tanggal]);
    ...
    const latestTimeResult = await executePamulang(checkDateQuery, [tanggal]);
