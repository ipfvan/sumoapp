...
export default async function handler(req, res) {
  try {
    if (req.method === 'GET') {
      ...
      const results = await executeCiledug(queryString, [startDate, endDate]);
      ...
      // Query untuk mendapatkan barang_id berdasarkan item dan kategori
        ...
        await executeCiledug(insertQuery, [tanggal, item, qty, penerima]);
      ...
      await executeCiledug(deleteQuery, [itemId]);
