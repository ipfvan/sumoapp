...
export default (req, res) => {
  if (req.method === 'GET') {
    ...
    const { kategori, item, tanggal, qty, penerima } = req.body;
    ...
    connection.query('DELETE FROM transaksi_keluar WHERE id = ?', [itemId], (error, results) => {
      if (error) {
