...
const addNotification = async (notificationData) => {
  try {
    ...
    const results = await executeCiledug(query, [nama, jam, tanggal, tanggal_daftar]);
    return results;
  } catch (error) {
...
const getNotifications = async () => {
  try {
    ...
    const results = await executeCiledug(query);
    return results;
  } catch (error) {
...
const markNotificationAsViewed = async (notificationIds) => {
  try {
    ...
    const results = await executeCiledug(query, notificationIds);
    return results;
  } catch (error) {
