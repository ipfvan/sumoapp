...
const MetodeBius = () => {
  ...
  const fetchMetodeBiusList = () => {
    axios.get('/api/cibinong/main/metodebius')
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('/api/cibinong/main/metodebius', newMetode)
      .then(() => {
        fetchMetodeBiusList();
  ...
  const handleUpdate = () => {
    axios.put(`/api/cibinong/main/metodebius?id=${editMetode.id}`, editMetode)
      .then(() => {
        fetchMetodeBiusList();
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`/api/cibinong/main/metodebius?id=${id}`) // Ganti dengan URL delete endpoint yang sesuai
      .then(() => {
