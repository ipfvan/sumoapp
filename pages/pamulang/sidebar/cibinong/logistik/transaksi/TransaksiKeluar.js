      ...
      axios.post('/api/cibinong/main/transaksi-keluar', data)
        .then(response => {
          ...
          if (penerima === 'Ciledug') {
            ...
            axios.post('/api/cibinong/main/submit-transaksi-masuk-ciledug', transaksiMasukData)
              .then(response => {
            ...
            axios.post('/api/cibinong/main/submit-transaksi-masuk-cipanas', transaksiMasukData)
              .then(response => {
            ...
            axios.post('/api/cibinong/main/submit-transaksi-masuk-pamulang', transaksiMasukData)
              .then(response => {
                console.log('Transaksi masuk Cipanas berhasil disubmit:', response.data);
              })
              .catch(error => {
