...
const JamUmum = () => {
  ...
  useEffect(() => {
    ...
    axios.get('/api/pamulang/main/configurations') // Gantilah '/api/pamulang/main/endpoint' dengan URL yang sesuai
      .then((response) => {
...
const handleUpdateClick = () => {
  ...
  axios.post('/api/pamulang/main/configurations', formData)
    .then((response) => {
      console.log('Configuration updated successfully');
      setEditing(false);

      // Lakukan fetch ulang untuk mendapatkan data yang paling mutakhir
      axios.get('/api/pamulang/main/configurations')
        .then((response) => {
          setJam(response.data);
        })
        .catch((error) => {
