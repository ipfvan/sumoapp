...
const MetodeSunat = () => {
  ...
  const fetchMetodeSunatList = () => {
    axios.get('/api/pamulang/main/metodesunat')
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('/api/pamulang/main/metodesunat', newMetode)
      .then(() => {
        fetchMetodeSunatList();
  ...
  const handleUpdate = () => {
    axios.put(`/api/pamulang/main/metodesunat?id=${editMetode.id}`, editMetode)
      .then(() => {
        fetchMetodeSunatList();
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`/api/pamulang/main/metodesunat?id=${id}`) // Ganti dengan URL delete endpoint yang sesuai
      .then(() => {
