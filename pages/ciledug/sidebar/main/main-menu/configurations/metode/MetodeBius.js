...
const MetodeBius = () => {
  ...
  const fetchMetodeBiusList = () => {
    axios.get('/api/ciledug/main/metodebius')
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('/api/ciledug/main/metodebius', newMetode)
      .then(() => {
        fetchMetodeBiusList();
  ...
  const handleUpdate = () => {
    axios.put(`/api/ciledug/main/metodebius?id=${editMetode.id}`, editMetode)
      .then(() => {
        fetchMetodeBiusList();
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`/api/ciledug/main/metodebius?id=${id}`) // Ganti dengan URL delete endpoint yang sesuai
      .then(() => {
