      ...
      axios.post('/api/ciledug/main/transaksi-keluar', data)
        .then(response => {
          ...
          if (penerima === 'Cibinong') {
            ...
            axios.post('/api/ciledug/cibinong/submit-transaksi-masuk-cibinong', transaksiMasukData)
              .then(response => {
            ...
            axios.post('/api/ciledug/pamulang/submit-transaksi-masuk-pamulang', transaksiMasukData)
              .then(response => {
                console.log('Transaksi masuk Pamulang berhasil disubmit:', response.data);
              })
              .catch(error => {
                console.error('Error submitting transaksi masuk pamulang:', error);
              });
          }
          ...
          axios.delete(`/api/ciledug/main/transaksi-keluar?id=${itemId}`)
            .then(response => {
              ...
              if (itemToDelete.penerima === 'Cibinong') {
                ...
                axios.delete('/api/ciledug/cibinong/delete-transaksi-masuk-cibinong', { params: deleteParams })
              ...
              if (itemToDelete.penerima === 'Pamulang') {
                ...
                // Perform delete operation using API untuk menghapus data berdasarkan tanggal_transaksi, barang_id, qty, dan pengirim
                axios.delete('/api/ciledug/pamulang/delete-transaksi-masuk-pamulang', { params: deleteParams })
                  .then(deleteResponse => { // Data berhasil dihapus, lakukan apa yang perlu dilakukan
