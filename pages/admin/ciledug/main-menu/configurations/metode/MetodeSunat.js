...
const MetodeSunat = () => {
  ...
  const fetchMetodeSunatList = () => {
    axios.get('/api/ciledug/metodesunat')
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('/api/ciledug/metodesunat', newMetode)
      .then(() => {
        fetchMetodeSunatList();
  ...
  const handleUpdate = () => {
    axios.put(`/api/ciledug/metodesunat?id=${editMetode.id}`, editMetode)
      .then(() => {
        fetchMetodeSunatList();
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`/api/ciledug/metodesunat?id=${id}`) // Ganti dengan URL delete endpoint yang sesuai
      .then(() => {
