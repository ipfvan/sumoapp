...
const MetodeBius = () => {
  ...
  const fetchMetodeBiusList = () => {
    axios.get('/api/ciledug/metodebius')
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('/api/ciledug/metodebius', newMetode)
      .then(() => {
        fetchMetodeBiusList();
  ...
  const handleUpdate = () => {
    axios.put(`/api/ciledug/metodebius?id=${editMetode.id}`, editMetode)
      .then(() => {
        fetchMetodeBiusList();
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`/api/ciledug/metodebius?id=${id}`) // Ganti dengan URL delete endpoint yang sesuai
      .then(() => {
