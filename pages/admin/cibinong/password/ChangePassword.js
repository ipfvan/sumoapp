...
const ChangePasswordCibinong = () => {
  ...
  useEffect(() => {
    ...
    axios.get('/api/cibinong/current-password')
      .then((response) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('/api/cibinong/update-password', { newPassword });
...
export default ChangePasswordCibinong;
