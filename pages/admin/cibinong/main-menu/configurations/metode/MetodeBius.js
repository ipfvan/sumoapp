...
const MetodeBius = () => {
  ...
  const fetchMetodeBiusList = () => {
    axios.get('/api/cibinong/metodebius')
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('/api/cibinong/metodebius', newMetode)
      .then(() => {
        fetchMetodeBiusList();
  ...
  const handleUpdate = () => {
    axios.put(`/api/cibinong/metodebius?id=${editMetode.id}`, editMetode)
      .then(() => {
        fetchMetodeBiusList();
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`/api/cibinong/metodebius?id=${id}`) // Ganti dengan URL delete endpoint yang sesuai
      .then(() => {
