...
const TransaksiKeluar = () => {
  ...
  const fetchFilteredData = async () => {
    try {
      const response = await axios.get(`/api/pamulang/transaksi-keluar`, {
        params: {
...
if  (pamulangauthenticated) {
    ...
    if (selectedKategori && selectedItem && tanggalTransaksi && qty && penerima) {
      ...
      axios.post('/api/pamulang/transaksi-keluar', data)
        .then(response => {
          ...
          if (penerima === 'Ciledug') {
            ...
            axios.post('/api/pamulang/submit-transaksi-masuk-ciledug', transaksiMasukData)
              .then(response => {
            ...
            axios.post('/api/pamulang/submit-transaksi-masuk-cibinong', transaksiMasukData)
              .then(response => {
                console.log('Transaksi masuk cibinong berhasil disubmit:', response.data);
              })
              .catch(error => {
...
if  (pamulangauthenticated) {
          ...
          axios.delete(`/api/pamulang/transaksi-keluar?id=${itemId}`)
            .then(response => {
              ...
              if (itemToDelete.penerima === 'Ciledug') {
                ...
                axios.delete('/api/pamulang/delete-transaksi-masuk-ciledug', { params: deleteParams })
              ...
              if (itemToDelete.penerima === 'Cibinong') {
                ...
                // Perform delete operation using API untuk menghapus data berdasarkan tanggal_transaksi, barang_id, qty, dan pengirim
                axios.delete('/api/pamulang/delete-transaksi-masuk-cibinong', { params: deleteParams })
                  .then(deleteResponse => { // Data berhasil dihapus, lakukan apa yang perlu dilakukan
                    console.log('Data from ciibinong deleted:', deleteResponse.data);
                  })
                  .catch(deleteError => {
  ...
  const fetchDetailedData = async () => {
    try {
      const response = await axios.get(`/api/pamulang/get-detailed-transaksi-keluar`, {
        params: {
          startDate: selectedStartDate,
          endDate: selectedEndDate,
        },
  ...
  const handleSimplifyClick = () => {
    ...
    axios.delete('/api/pamulang/simplify-transaksi-keluar')
      .then(response => {
