...
const MetodeSunat = () => {
  ...
  const fetchMetodeSunatList = () => {
    axios.get('/api/pamulang/metodesunat')
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('/api/pamulang/metodesunat', newMetode)
      .then(() => {
        fetchMetodeSunatList();
  ...
  const handleUpdate = () => {
    axios.put(`/api/pamulang/metodesunat?id=${editMetode.id}`, editMetode)
      .then(() => {
        fetchMetodeSunatList();
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`/api/pamulang/metodesunat?id=${id}`) // Ganti dengan URL delete endpoint yang sesuai
      .then(() => {
