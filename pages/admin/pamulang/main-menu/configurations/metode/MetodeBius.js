...
const MetodeBius = () => {
  ...
  const fetchMetodeBiusList = () => {
    axios.get('/api/pamulang/metodebius')
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('/api/pamulang/metodebius', newMetode)
      .then(() => {
        fetchMetodeBiusList();
  ...
  const handleUpdate = () => {
    axios.put(`/api/pamulang/metodebius?id=${editMetode.id}`, editMetode)
      .then(() => {
        fetchMetodeBiusList();
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`/api/pamulang/metodebius?id=${id}`) // Ganti dengan URL delete endpoint yang sesuai
      .then(() => {
