...
const ChangePasswordPamulang = () => {
  ...
  useEffect(() => {
    ...
    axios.get('/api/pamulang/current-password')
      .then((response) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('/api/pamulang/update-password', { newPassword });
...
export default ChangePasswordPamulang;
